...
func (m *Rule) ToItem() map[string]any {
...
func (m *Rule) GetColumnsAndValues(setPrimaryKey bool, setZeroValues bool, forceSetValuesForFields ...string) ([]string, []any, error) {
...
func SelectRules(ctx context.Context, tx pgx.Tx, where string, orderBy *string, limit *int, offset *int, values ...any) ([]*Rule, int64, int64, int64, int64, error) {
	...
	useInstead, shouldSkip := query.ShouldSkip[Rule](ctx)
	if !shouldSkip {
...
func InsertRules(ctx context.Context, tx pgx.Tx, objects []*Rule, setPrimaryKey bool, setZeroValues bool, forceSetValuesForFields ...string) ([]*Rule, error) {
	var columns []string
	values := make([]any, 0)
...
func handlePostRule(arguments *server.LoadArguments, db *pgxpool.Pool, waitForChange server.WaitForChange, objects []*Rule, forceSetValuesForFieldsByObjectIndex [][]string) ([]*Rule, int64, int64, int64, int64, error) {
	...
	returnedObjects, err := InsertRules(arguments.Ctx, tx, objects, false, false, slices.Collect(maps.Keys(forceSetValuesForFieldsByObjectIndexMaximal))...)
	if err != nil {
