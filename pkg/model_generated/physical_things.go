...
func (m *PhysicalThing) LockTableWithRetries(ctx context.Context, tx pgx.Tx, timeout time.Duration, backoff time.Duration) error {
	return query.LockTableWithRetries(ctx, tx, PhysicalThingTable, timeout, backoff)
}
