...
var tableByNameAsJSON = []byte(`{
  ...
  "video_with_seen_person": {
    "tablename": "video_with_seen_person",
    "oid": "20564",
    "schema": "public",
    "reltuples": -1,
    "relkind": "v",
