...
func init() {
	...
	selectFuncByTableName["seconds"] = genericSelectSeconds
	columnNamesByTableName["seconds"] = SecondsColumns
}
...
var TableNames = []string{"firsts", "seconds"}
